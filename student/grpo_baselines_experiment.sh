#!/bin/bash
#SBATCH --job-name=q1-dns5508-baselines
...
# --- Baseline sweep (best LR from lr sweep = 2e-5) ---
LOSS_TYPES=(reinforce_with_baseline no_baseline)
LOSS_TYPE=${LOSS_TYPES[$SLURM_ARRAY_TASK_ID]}
...
echo "=============================="
echo "GRPO Baselines Experiment"
echo "=============================="
...
uv run python /gpfs/scratch/an4462/at6646/dns5508/LLMReasonersAssignment3/student/grpo_trainer.py \
  ...
  --wandb_run_name "baseline_${LOSS_TYPE}"
